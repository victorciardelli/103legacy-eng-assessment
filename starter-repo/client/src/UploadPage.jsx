...
export default function UploadPage() {
  ...
  const handleUpload = async () => {
    ...
    // BUG: Caption is sent to the server but the server never stores it in the database.
    // The contributor fills this out, it gets sent in the request, and it silently vanishes.
    // When the card is compiled, all captions are empty.
    ...
    <div style={styles.container}>
      ...
      {status === "done" ? (
        ...
        <div>
          ...
          <div style={styles.field}>
            <label>Caption for your video</label>
            <p style={{ fontSize: "12px", color: "#999", margin: "4px 0" }}>
              This text will appear as a subtitle when your video plays in the card.
              Example: "Happy birthday from the whole family!"
            </p>
            {/* BUG: No character limit on the caption. Long captions will overflow
                the video overlay. No preview of how the caption will look.
                BUG: No sanitization — user could paste HTML or special characters
                that break the caption rendering in the compiled video. */}
            <input
              type="text"
              value={caption}
